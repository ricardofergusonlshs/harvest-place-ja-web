  ...
  return (
    <section className="relative overflow-hidden bg-[linear-gradient(180deg,#FFFDF7_0%,#FAF8F0_58%,#EAF5E7_100%)]">
      <div className="mx-auto max-w-[1450px] px-4 pb-5 pt-7 sm:px-6 sm:pb-6 sm:pt-8 lg:px-10 lg:pb-8 lg:pt-8">
        <div className="relative min-h-[560px] overflow-hidden rounded-[30px] border border-[#D8E5D4] bg-[#FFFDF7] shadow-[0_24px_70px_rgba(24,59,40,0.10)] sm:min-h-[590px] lg:min-h-[545px] xl:min-h-[560px]">
          ...
          <div className="absolute inset-y-0 right-0 hidden w-[74%] overflow-hidden lg:block">
            ...
            />
            <div className="absolute inset-0 bg-[linear-gradient(90deg,#FFFDF7_0%,rgba(255,253,247,0.92)_28%,rgba(255,253,247,0.48)_48%,rgba(255,253,247,0)_74%)]" />
            <div className="absolute inset-0 bg-gradient-to-b from-[#FFFDF7]/5 via-transparent to-[#183B28]/8" />
          </div>

          <div className="absolute inset-x-0 bottom-0 block h-[310px] overflow-hidden lg:hidden">
            <SafePublicImage
              src={HERO_IMAGE}
              fallbackSrcs={HERO_IMAGE_FALLBACKS}
              alt="Fresh Jamaican vegetables in a basket"
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-b from-[#FFFDF7] via-[#FFFDF7]/70 to-transparent" />
          </div>

          <div className="relative z-20 flex min-h-[560px] flex-col justify-start px-6 py-8 sm:min-h-[590px] sm:px-8 sm:py-10 lg:min-h-[545px] lg:w-[56%] lg:justify-center lg:px-10 lg:py-12 xl:min-h-[560px] xl:w-[54%] xl:px-11">
            ...
            <h1 className="mt-5 max-w-[620px] font-serif text-[clamp(3.4rem,6.1vw,5.6rem)] font-black leading-[0.91] tracking-[-0.058em] text-[#183B28] lg:max-w-[650px]">
              Fresh From
              <br />
              Our Farm To
              <br />
          ...
          <div className="absolute right-4 top-4 z-30 hidden sm:block lg:right-6 lg:top-6">
            <div className="relative h-[104px] w-[104px] lg:h-[118px] lg:w-[118px]">
              <Image
                src={CERTIFIED_BADGE_IMAGE}
                alt="Certified Jamaican premium quality badge"
                fill
                sizes="118px"
                className="object-contain drop-shadow-[0_14px_30px_rgba(24,59,40,0.30)]"
                unoptimized
              />
            </div>
          </div>
